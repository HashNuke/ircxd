defmodule Ircxd.Whois do
  ...
  @doc "Parses an `RPL_WHOISUSER` reply."
  ...
  @doc "Parses an `RPL_WHOWASUSER` reply."
  ...
  @doc "Parses an `RPL_WHOISCHANNELS` reply."
