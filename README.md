...
[![CI](https://img.shields.io/github/check-suites/HashNuke/ircxd/v1.1.1?label=CI)](https://github.com/HashNuke/ircxd/actions/workflows/ci.yml)
...
I've tried to build an IRC client & app many times ever since I first used Elixir. But priorities and other shiny stars
