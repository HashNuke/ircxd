...
| Input limits and malformed wire handling | partial | `server_limits_test.exs`, `server_registration_test.exs`, `server_protocol_errors_test.exs`; oversized lines return 417, unknown commands return 421, malformed PART returns 461, and registration/command errors are covered, add malformed parameter policy |
