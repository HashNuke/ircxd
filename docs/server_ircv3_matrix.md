...
| Standard replies and labeled responses | partial | `server_labeled_response_test.exs`; labeled WHOIS response sequences preserve request labels, while broader labeled command coverage and server standard-reply emission remain |
