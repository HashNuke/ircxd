...
| Batches, multiline, history, and redaction | partial | `server_batch_test.exs`; client-originated `BATCH` start/end framing is relayed around tagged messages to actual recipients, while server-originated multiline/history delivery and redaction remain |
