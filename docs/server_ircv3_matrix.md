...
| Server information (`MOTD`, `LIST`, `LUSERS`) | partial | `server_motd_test.exs`, `server_list_test.exs`, `server_lusers_test.exs`; configurable MOTD, channel LIST, and live LUSERS numerics exist, add remaining query commands |
