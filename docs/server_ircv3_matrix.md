...
| Server information (`MOTD`, `LIST`) | partial | `server_motd_test.exs`, `server_list_test.exs`; configurable MOTD and channel LIST numerics exist, add remaining query commands |
