...
| Server information (`MOTD`, `LIST`, `LUSERS`, `VERSION`) | partial | `server_motd_test.exs`, `server_list_test.exs`, `server_lusers_test.exs`, `server_version_test.exs`; configurable MOTD, channel LIST, live LUSERS, and VERSION numerics exist, add remaining query commands |
