defmodule Ircxd.ClientMultilineTest do
  ...
  test "rejects outbound multiline before required capabilities are negotiated" do
    server =
      start_supervised!(
        {ScriptedIrcServer,
         test_pid: self(),
    ...
    refute_receive {:scripted_irc_line, "BATCH +ircxd-1 draft/multiline #elixir"}, 250
  end
end
